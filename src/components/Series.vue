    ...
    >
      ...
      <div v-else>
        ...
        <div v-else-if="lifes==0" class="grid grid-cols-1 w-full pt-12 gap-4">
          ...
          <p class="text-xl font-black">Obtuviste {{puntuacionSeries}} puntos</p>
        ...
        <div v-else class="relative">
          ...
          <div class="grid container grid-cols-1 sm:grid-cols-2 gap-4 md:mt-12">
            <div v-for="serie in seriesToPlay" :key="serie.id" class="shadow-xl rounded">
              <div
                :id="serie.id"
              ...
              >
                ...
                <div class="px-1 py-1 lg:px-6 lg:py-4">
                  ...
                  >{{ serie.name}}</div>
                  <p class="text-xs">Fecha de emisión:{{serie.released}}</p>
                  <p class="text-gray-700 font-black">
                    <span
                      v-for="genre in serie.genres"
                      :key="genre"
                      class="border-2 text-xs mx-1 border-full bg-gray-400 px-2 rounded-full"
                    >{{genre}}</span>
                  </p>
                </div>
              </div>
